...
export default function UploadQueue({
 ...
 .iu-drop{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;width:100%;padding:22px;border:1px dashed #475569;border-radius:12px;background:#ffffff02;color:#c8d0dc;cursor:pointer;font-family:inherit;font-size:13px;transition:background .2s,border-color .2s}
 ...
 .iu-progress{display:block;appearance:none;border:0;width:100%;height:3px;background:#ffffff09;border-radius:3px;margin-top:9px;overflow:hidden}.iu-progress::-webkit-progress-bar{background:#ffffff09;border-radius:3px}.iu-progress::-webkit-progress-value{background:#ad97da;border-radius:3px}.iu-progress::-moz-progress-bar{background:#ad97da;border-radius:3px}
 ...
 `}</style>
      ...
      {message && <output className="iu-message">{message}</output>}
      {items === undefined && (
